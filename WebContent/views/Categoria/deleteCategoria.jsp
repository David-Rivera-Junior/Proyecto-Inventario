...
<body class="container-fluid">
		 ...
		 <h1 class="text-center mt-fixed-nav">ELIMINAR CATEGORIA</h1>
		 
         <c:url value="/CategoriaController" var="registerUrl" /> 
	         ...
	         <form method="POST" action="${registerUrl}" class="col-6 offset-3">
	                <c:forEach items="${datos}" var="categoria">
	                    ...
	                    <section class='alert alert-danger col-8 offset-2 text-center ' role='alert' id='alerta'>
	                        ¿Esta seguro de eliminar la categoria ${categoria.nombreCategoria}?
	                    </section>               
	                </c:forEach>
