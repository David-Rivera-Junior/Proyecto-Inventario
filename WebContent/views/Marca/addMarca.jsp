...
<body class="container-fluid">
	...
	<h1 class="text-center mt-fixed-nav">AGREGAR MARCA</h1>
	 ...
	 <section>
           <form action="/ProyectoInventario/MarcaController" method="POST" class="col-8 offset-2" id="frmMain">
				<section class="form-group row">
				    <label  class="col-3"><h3>Marca:</h3></label>
				    <input type="hidden" value="add" name="option">
				    <input type="text" class="form-control col-7" id="marca" name="marca" autocomplete="off">
				</section >
				<section class="form-group row">
