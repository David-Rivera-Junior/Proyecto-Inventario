...
<body class="container-fluid">
	...
	<h1 class="text-center mt-fixed-nav">AGREGAR PRODUCTO</h1>
      ...
      <section>
           <form action="/ProyectoInventario/ProductoController" method="POST" class="col-8 offset-2" id="frmMain">
				<section class="form-group row">
				    ...
				    <input type="text" class="form-control col-8" id="producto" name="nombre_producto" autocomplete="off">
				</section >
				<section class="form-group row">
				    <label  class="col-3"><h3>Presentacion:</h3></label>
				    <input type="text" class="form-control col-8" id="producto" name="presentacion" autocomplete="off">
				</section >
			    <section class="form-group row">
