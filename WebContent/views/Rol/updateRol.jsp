...
<body class="container-fluid">
	<jsp:include page="../componentes/navbar.jsp" />
      ...
      <h1 class="text-center mt-fixed-nav">MODIFICAR ROL</h1>
	           ...
	           <form action="/ProyectoInventario/RolController" method="POST" class="col-8 offset-2" id="frmMain">
			  		<c:forEach items="${datos}" var="rol">
		                <section class="form-group row">
						    ...
						    <input type="hidden" class="form-control col-10" value="${rol.idRol }" name="id_rol">
						    <input type="hidden" value="update_data" name="option">
						    <input type="text" class="form-control col-8" value="${rol.rol}" name="rol" autocomplete="off">
						</section >        	
	                </c:forEach>
