...
<body class="container-fluid">
	<jsp:include page="../componentes/navbar.jsp" />
      ...
      <h1 class="text-center mt-fixed-nav">AGREGAR ENTRADA</h1>
      ...
      <section> 
           <form action="/ProyectoInventario/EntradaController" method="POST" class="col-8 offset-2" id="frmMain">
		  		<section>
		  		<section class="form-group row">
				    <label  class="col-3"><h3>Cantidad:</h3></label>
				    <input type="hidden" value="add" name="option">
				    <input type="number" class="form-control col-4" name="cantidad" id="producto" autocomplete="off">
				</section>
			    <section class="form-group row">
